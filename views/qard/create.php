        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-9">
                <div id="cardtabs">
					...
					<div id="cardtabs-preview" role="tabpanel" class="tab-pane active">
						<img src="<?=Yii::$app->homeUrl?>images/block_demo_icon.png" alt="">
						<h4>Hello! I am <i>The</i> <strong>Block</strong>. Start by adding me to your Qard.</h4>
						<h4>Learn more about my powers </h4>
						<h4><button class="btn btn-default" data-toggle="modal" data-target="#myModaltut">See Tutorial</button> </h4>
					</div>
					<!-- Modal -->
...
<!-- Qard style pop up -->
	...
	$('.cardblock-header').hide();
	$('.nav').on("click",function(){
		$('.cardblock-header').show();
	});
