...
class FacebookController extends \yii\web\Controller
{
	...
	$this->client_id= '1054501381284066';//'1142793035779809';//app id of facebook//
	$this->client_secret= 'b4e61fed905c6866bfd1bf2a99fd3e2d';//'8dc64cf509704e2cd4e2dcd5ed1a1aea';//app secret key of facebook//
